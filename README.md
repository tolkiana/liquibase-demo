...
This is a Demo project which purpose is to showcase a small service that uses Liquibase for a tutorial I'm writting. During the making of this project I wanted to also try a Reactive approach to connect with the Database by using R2DBC. 
